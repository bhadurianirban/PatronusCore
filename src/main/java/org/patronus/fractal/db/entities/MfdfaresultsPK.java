...
public class MfdfaresultsPK implements Serializable {
    ...
    public MfdfaresultsPK(String mfdfaresultsslug, int resultid) {
    ...
    public String toString() {
        return "org.dgrf.fractal.db.entities.MfdfaresultsPK[ mfdfaresultsslug=" + mfdfaresultsslug + ", resultid=" + resultid + " ]";
    }
